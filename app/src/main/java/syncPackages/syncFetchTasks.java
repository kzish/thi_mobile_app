...
public class syncFetchTasks {
    ...
    public static void sync() {
        ...
        new AlertDialog.Builder(HomeActivity.activity)
                .setMessage("Current Inspections will be cleared, Proceed?").
                setTitle("Warning?")
                .setCancelable(false)
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        HomeActivity.pd.showCustomDialog(HomeActivity.activity, "fetching tasks...");
                        _doSync();
                    }
                })
